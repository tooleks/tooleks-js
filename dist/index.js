/*! tooleks v1.4.1. Copyright (c) Oleksandr Tolochko. */
...
var optional = __webpack_require__(90);

module.exports = (0, _freeze2.default)((0, _extends3.default)({}, types, { clone: clone, optional: optional }));
...
var isBoolean = __webpack_require__(130);
var isDefined = __webpack_require__(129);
var isFunction = __webpack_require__(128);
var isNull = __webpack_require__(127);
var isNumber = __webpack_require__(126);
var isNumeric = __webpack_require__(125);
var isObject = __webpack_require__(124);
var isString = __webpack_require__(113);
...
var timeout = __webpack_require__(133);
var waitUntil = __webpack_require__(132);

module.exports = (0, _freeze2.default)({ Defer: Defer, timeout: timeout, waitUntil: waitUntil });
...
var Mapper = __webpack_require__(76);
...
var $export = __webpack_require__(3);
var $task = __webpack_require__(36);
...
var _setImmediate2 = __webpack_require__(80);
...
var EventEmitter = function () {
    ...
    (0, _createClass3.default)(EventEmitter, [{
        ...
        value: function emitAsync(eventName, payload) {
            ...
            var defer = new Defer();
            (0, _setImmediate3.default)((0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
                var results;
...
var DependencyContainer = function () {
    ...
    function DependencyContainer() {
        (0, _classCallCheck3.default)(this, DependencyContainer);
    ...
    (0, _createClass3.default)(DependencyContainer, [{
        key: "_createInstance",
        value: function _createInstance(binding) {
            var dependencies = this._resolveDependencies(binding.dependencies);
            var instance = null;
            if (binding.factory) {
                instance = binding.type.apply(binding, (0, _toConsumableArray3.default)(dependencies));
            } else {
                instance = new (Function.prototype.bind.apply(binding.type, [null].concat((0, _toConsumableArray3.default)(dependencies))))();
            }
            return instance;
        }
...
var DependencyContainer = __webpack_require__(88);
...
function cloneMap(value) {
    return new _map2.default(clone((0, _from2.default)(value)));
}
...
function cloneObject(value) {
    ...
    // DOM node object.
        ...
        // Object literal.
                ...
                return (0, _keys2.default)(value).reduce(function (clonedObject, key) {
...
function clone(value) {
    ...
    throw new Error("Unable to clone the " + (typeof value === "undefined" ? "undefined" : (0, _typeof3.default)(value)) + ".");
}
...
var DependencyContainer = __webpack_require__(89);
var EventEmitter = __webpack_require__(86);
var Mapper = __webpack_require__(77);

module.exports = (0, _freeze2.default)((0, _extends3.default)({}, async, utils, { DependencyContainer: DependencyContainer, EventEmitter: EventEmitter, Mapper: Mapper }));
